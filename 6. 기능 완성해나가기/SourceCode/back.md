...
#### D:\_React\_ReactStudy_inflearn\React-nodebird\6. 기능 완성해나가기\back\routes\post.js
```js
const express = require('express');
const multer = require('multer');
const path = require('path');
...
#### D:\_React\_ReactStudy_inflearn\React-nodebird\6. 기능 완성해나가기\back\routes\posts.js
```js
const express = require('express');
const db = require('../models');
...
#### D:\_React\_ReactStudy_inflearn\React-nodebird\6. 기능 완성해나가기\back\routes\user.js
```js
const express = require('express');
const bcrypt = require('bcrypt');
const db = require('../models');
